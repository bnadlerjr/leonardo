...
Leonardo = (function () {
    ...
    return {
        ...
        columnChart: function (domID, series, labels, options) {
            ...
            // Draw series bars
            // TODO: Need to adjust the distances between labels.
        ...
        lineChart: function (domID, series, labels, options) {
            ...
            // Draw series lines
            // TODO: Tracking the old x & y values here is ugly. Push
            // responsibility for this to to a line helper function
            series.forEach(function (element) {
                var lastX = 0,
                    lastY = 0,
                    first_point = true;

...
function init(domID,max,num_labels,options){maxValue=max;var paddedWidth=opts.width-(opts.padding*2),paddedHeight=opts.height-(opts.padding*2),axisAreaPercentage=1-opts.plotAreaPercentage,ratio=maxValue/opts.scaleSize,i=opts.scaleSize;plotArea.x=axisAreaPercentage*paddedWidth+opts.padding;plotArea.y=opts.padding;plotArea.width=opts.plotAreaPercentage*paddedWidth;plotArea.height=paddedHeight-(axisAreaPercentage/2*opts.height);plotArea.xOffset=(plotArea.width/num_labels/2)-opts.padding;scaleValues[0]=0;while(i--){scaleValues.push(((i+1)*ratio).toFixed(0));}
